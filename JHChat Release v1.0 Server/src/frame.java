...
public class frame extends JFrame {
	...
	private JTextField txtExperimentalNotDone;
	...
	public frame() {
		...
		txtExperimentalNotDone = new JTextField();
		txtExperimentalNotDone.setText("Experimental!!! not done yet");
		scrollPane_1.setViewportView(txtExperimentalNotDone);
		txtExperimentalNotDone.setColumns(10);
